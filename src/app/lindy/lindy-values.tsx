  ...
  },
  {
    ...
    links: [
      <Link
        ...
        key='example-notes' className='hover:text-blue-500'
      >
        <NotionLogoIcon className='w-5 h-5 inline leading-none' /> Example of Notes <ArrowRightIcon className="w-5 h-5 inline"/>
      </Link>,
      <Link
        href='https://paperplane-ui.vercel.app/Components/page-transitions'
        key='documentation-notes' className='hover:text-blue-500'
      >
        <NotionLogoIcon className='w-5 h-5 inline leading-none' /> Example of Documentation <ArrowRightIcon className="w-5 h-5 inline"/>
      </Link>,
    ],
  },
  {
