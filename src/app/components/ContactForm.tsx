      ...
      <form action="#" method="POST" className="mx-auto  max-w-xl ">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="company" className="block text-sm font-semibold leading-6 text-primary">
              Company
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="phone-number" className="block text-sm font-semibold leading-6 text-primary">
              Phone number
            </label>
