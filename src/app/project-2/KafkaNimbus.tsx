...
const KafkaNimbus = (props: Props) => {
  return (
    <div className={` w-full h-full overflow-scroll z-30`}>
      <h3 className='text-3xl text-justify font-bold mt-14 mb-2'>Project Details</h3>
      <div className='my-4 '>
        <article>
          <video
            width='100%'
          ...
          <div className='text-justify'>
            <div className='rounded-lg shadow-lg bg-neutral-100 px-4 py-6 border-2 '>
              <h3 className='text-justify text-xl font-bold mb-2'>
                What it does:
              </h3>
              <p>
            ...
            <h2 className='text-justify text-3xl font-bold mt-24 mb-4'>
              My Contributions
            </h2>
            <p>
            ...
            <h2 className='text-justify text-3xl font-bold mt-8'>
